...
public interface ContinuumWebService
{
     ...
     */ 
    Project getProject(int projectId) throws XFireFault;
    
    /**
     * @@WebMethod()
     * @@.projectInfo WebParam("Project")
     */ 
    void updateProject(Project project) throws XFireFault;
     ...
     */ 
    Collection getBuildDefinitions(int projectId) throws XFireFault;
     ...
     */ 
    Build getLatestBuild( int projectId ) throws XFireFault;
     ...
     */
    ScmResult getScmResult( int projectId )
        throws XFireFault;
